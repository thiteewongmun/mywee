        ...
        <div class="row">
            <div class="col">
               <div style="width:50%;margin:auto;">
                    <button id="access_acount"  class="btn btn-dark">เชื่อต่อWallet</button>
                    <button id="acc_about" class="btn btn-danger" style="border-radius:30px;">บัญชีของคุณ : </button>
               </div>
            </div>
        </div>
        <br>
            ...
            <div class="col">
                <div class="card w-50" style="margin:auto;">
                    <div class="card-header">
                        <h1 class="text-dark">.......อิมตูดเหม็น.....</h1>
                    </div>
                    <div class="card-body">
                        <center>
                        <div  id ="alert_box" style="display:none;"></div>
                        <img src="me1.jpg" style="width:auto;height:250px;">
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            <div class="col">
                                <center>
                               <button class="btn btn-sm btn-primary"style="border-radius:30px;"> บัญชีของเรา : 0x89b07dbC759eEF14616035b4dAe17861F0CE8CF5 </button>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col col-4">
                                <p style='float:right;'>จำนวนที่ต้องการ(ETH)</p>
                            </div>
                            <div class="col col-4">
                                <input class="form-control" type="number" id="donate_input" placeholder="จำนวนที่ต้องการ">
                            </div>
                            <div class="col col-4">
                                  <buton id="donate_btn"  class="btn btn-success">โดเนทเลย!</buton>
                            </div>
                        </div>
                    </div>
                </div>
